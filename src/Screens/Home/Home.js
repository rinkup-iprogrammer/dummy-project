  ...
  return (
    <View style={{height: '100%'}}>
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate(screens.SCREEN_2)}
          style={{
            margin: 10,
            padding: 10,
            borderRadius: 10,
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate(screens.SCREEN_3)}
          style={{
            margin: 10,
            padding: 10,
            borderRadius: 10,
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate(screens.PERMISSION)}
          style={{
            margin: 10,
            padding: 10,
            borderRadius: 10,
        ...
        <TouchableOpacity
          onPress={async () => {
            dispatch(fetchUser());
            navigateToScreen(screens.SCREEN_2);
          }}
          style={{
            margin: 10,
            padding: 10,
